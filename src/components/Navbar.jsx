const Navbar = () => {
  return (
    <>
      <div className="z-[999] backdrop-blur-[6px] w-full fixed px-14 py-4 flex justify-between items-center  font-['Neue Montreal']">
        <div className="logo">
          <svg
        ...
        <div className="flex gap-10 links">
          {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
            (item, index) => (
              <a
                className={`font-[400] cursor-pointer hover:tracking-[4px] duration-300 capitalize text-md ${
                  index === 4 && "ml-24"
                }`}
                key={index}
              >
